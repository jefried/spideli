        ...
        body: Stack(
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Container(
                height: config.App(context).appHeight(100) - (config.App(context).appHeight(29.5) - 50),
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        height: config.App(context).appHeight(100) - (config.App(context).appHeight(29.5) - 50) - 50,
                              ...
                              children: <Widget>[
                                ...
                                IntlPhoneField(
                                  ...
                                  onChanged: (phone) {
                                    ...
                                    _con.user.phone=phone.completeNumber;
                                  },
                                ),
                                SizedBox(height: 30),
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: "Email (optional)",//S.of(context).email,
                                    labelStyle: TextStyle(color: Theme.of(context).accentColor),
                                    contentPadding: EdgeInsets.all(12),
